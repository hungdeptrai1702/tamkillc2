...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("TamKijj C2 processing...: " + url );

        String[] SUrl = url.split("://");

        System.out.println("Welcome to TamKijj c2");
        ...
        System.out.println("TamKijj C2 by trangiahung");
        ...
        System.out.println("TamKijj C2 starting attack");
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Tamkijj C2 can't connect to website");
        }
        Dos.url = url;
    }
    ...
    private void sslCheckConnection(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("TamKijj C2 processing");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("TamKijjC2: " + responseCode + "Thread: " + this.seq);
    }
